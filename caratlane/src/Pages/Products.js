  ...
  return (
    <>
      ...
      <Grid container spacing={2}>
        <Grid sx={{ marginLeft: 9 ,}} display="flex">
          {Buttons.map((button, index) => (
            <Grid item key={index}
              sx={{ marginTop: 6, marginRight: 2,display:{xs:'none', md:'block'} }}
            >
              <button
                style={{
                  padding: '10px 20px',
      ...
      <Grid container spacing={2} marginTop="50px">
        <Grid item md={2} sx={{ marginLeft: 5 ,  display:{xs:'none', md:'block'}}}>
          <div style={{ display: "flex", alignItems: "center" }}>
            <Typography variant="h2" sx={{ marginLeft: 2,fontSize:"1rem" }}>FILTERS</Typography>
            <Typography variant="p" sx={{ marginLeft: 3,fontSize:"0.8rem" }}>CLEAR ALL</Typography>
          </div>
          <Divider sx={{ margin: 2 }} />
          <Typography variant="h2" sx={{ marginLeft: 2, margin: 3 }}>Price</Typography>
          <Grid item sx={{ marginLeft: 1 }}>
            {filter.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">{item.count}</Typography>
              </div>
            ))}
          </Grid>
            ...
            {openData && (
              <div style={{ marginLeft: "9px" }}>
                ...
                {filter.map((item, index) => (
                  <div key={index} style={{ display: "flex", alignItems: "center" }}>
                    <Checkbox {...label} />
                    <Typography variant="p" fontSize="0.8rem" color="#4F3267">{item.count}</Typography>
                  </div>
                ))}
              </div>
            )}
          ...
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Product Type</Typography>
            <Checkbox {...label} /> Rings
            <Divider />
          </Grid>
          <Grid marginTop="10px" marginLeft="10px">
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Weight Range</Typography>
            {Weight.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">{item.weight}</Typography>
              </div>
            ))}
            <Divider />
          </Grid>
          <Grid marginTop="10px" marginLeft="10px">
            ...
            {Material.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography variant="body1" fontSize="0.8rem">{item.name}</Typography>
              </div>
            ))}
            {openData && (
          ...
          <Grid marginTop="10px" marginLeft="10px">
            ...
            {Metal.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">{item.metal}</Typography>
              </div>
            ))}
            {openData && (
              <div style={{ marginLeft: "3px" }}>
                ...
                {Metall.map((item, index) => (
                  <div key={index} style={{ display: "flex", alignItems: "center" }}>
                    <Checkbox {...label} />
                    <Typography variant="p" fontSize="0.8rem" color="#4F3267">{item.metal}</Typography>
                  </div>
                ))}
              </div>
            )}
          ...
          <Grid marginTop="10px" marginLeft="10px">
            ...
            {Ring.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">{item.ring}</Typography>
              </div>
            ))}
            {openData && (
              <div style={{ marginLeft: "3px" }}>
                ...
                {Rings.map((item, index) => (
                  <div key={index} style={{ display: "flex", alignItems: "center" }}>
                    <Checkbox {...label} />
                    <Typography variant="p" fontSize="0.8rem"color="#4F3267">{item.ring}</Typography>
                  </div>
                ))}
              </div>
            )}
          ...
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Shop for</Typography>
            <Checkbox {...label} /> Women
            <Divider />
          </Grid>
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Occasion</Typography>
            <div>
          ...
          <Grid marginTop="10px" marginLeft="10px">
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Ring Style</Typography>
          ...
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Gifts</Typography>
            {gifts.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">{item.gift}</Typography>
              </div>
            ))}
          </Grid>
          <Divider />
          <Grid sx={{ marginLeft: 1 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Discounts</Typography>
            {discount.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267" display="flex">{item.discount}</Typography>
              </div>
            ))}
            <Divider />
          </Grid>
          <Grid sx={{ marginLeft: 1 }}>
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Gemstone colour</Typography>
            <Checkbox {...label} /> Red
            <Divider />
          </Grid>
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2 ,fontSize:"1rem"}}>Collections</Typography>
            <Checkbox {...label}
               /> Love Letters
            <Divider />
          </Grid>
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2 ,fontSize:"1rem"}}>Try@Home</Typography>
            <Checkbox {...label} /> 1
            <Divider />
          </Grid>
          <Grid marginTop="10px" marginLeft="10px">
            <Typography variant="h2" sx={{ margin: 2,fontSize:"1rem" }}>Curated by</Typography>
            {CuratedBy.map((item, index) => (
              <div key={index} style={{ display: "flex", alignItems: "center" }}>
                <Checkbox {...label} />
                <Typography variant="body1" fontSize="0.8rem" color="#4F3267">
            ...
            {openData && (
              <div style={{ marginLeft: "2px" }}>
                ...
                {CuratedByy.map((item, index) => (
                  <div key={index} style={{ display: "flex", alignItems: "center" }}>
                    <Checkbox {...label} />
                    <Typography variant="p" fontSize="0.8rem" color="#4F3267">{item.Curated}</Typography>
                  </div>
                ))}
              </div>
            )}
          ...
          <Grid sx={{ marginLeft: 2 }}>
            <Typography variant="h2" sx={{ margin: 2 ,fontSize:"1rem"}}>Fast Delivery</Typography>
            <Checkbox {...label} /> Fast Delivery
          </Grid>
        </Grid>
        <Grid item xs={12} md={9} sx={{ justifyContent:'center'}}>
